...
$('.img_btn').on('click', function () {
	downloadImage("image/save/5.jpg", "download", true);
});

$('.shop_btn').on('click', function () {
	link = $(this).index('.shop_btn');
	if (link == 0) {window.open('https://www.lotteon.com/p/product/LE1205916647', '_blank'); CountCheck('아바몰리 상품1'); }
	if (link == 1) {window.open('https://www.lotteon.com/p/product/LE1205922714', '_blank'); CountCheck('아바몰리 상품2'); }
	if (link == 2) {window.open('https://www.lotteon.com/p/product/LE1205922712', '_blank'); CountCheck('아바몰리 상품3'); }
});
