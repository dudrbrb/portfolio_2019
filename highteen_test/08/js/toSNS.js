...
function toSNS(sns, strTitle, url) {
    ...
    function kakaoShare() {
        ...
        Kakao.Link.sendDefault({
            objectType: 'feed',
            content: {
                title: '연극동아리 지도 선생님, CLUB TEACHER',
                description: '내가 “하이틴 무비＂에 출연한다면?\n나의 하이틴 재질 알아보기',
                imageUrl: "https://ilotteshopping.com/highteen_test/image/thumb/8.png",
                link: {
                    mobileWebUrl: 'https://ilotteshopping.com/highteen_test/08',
                    webUrl: 'https://ilotteshopping.com/highteen_test/08'
                },
                imageWidth: 1200,
                imageHeight: 600,
            },
