...
$('.img_btn').on('click', function () {
	downloadImage("image/save/8.jpg", "download", true);
});

$('.shop_btn').on('click', function () {
	link = $(this).index('.shop_btn');
	if (link == 0) {window.open('https://www.lotteon.com/p/product/LE1205944951', '_blank'); CountCheck('해브레스 상품1'); }
	if (link == 1) {window.open('https://www.lotteon.com/p/product/LE1205928438', '_blank'); CountCheck('해브레스 상품2'); }
	if (link == 2) {window.open('https://www.lotteon.com/p/product/LE1205928437', '_blank'); CountCheck('해브레스 상품3'); }
	if (link == 3) {window.open('https://www.lotteon.com/p/product/LE1205922713', '_blank'); CountCheck('해브레스 상품4'); }
