...
$('.img_btn').on('click', function () {
	downloadImage("image/save/6.jpg", "download", true);
});

$('.shop_btn').on('click', function () {
	link = $(this).index('.shop_btn');
	if (link == 0) {window.open('https://www.lotteon.com/p/product/LE1205916654', '_blank'); CountCheck('EYEYE 상품1'); }
	if (link == 1) {window.open('https://www.lotteon.com/p/product/LE1205916650', '_blank'); CountCheck('EYEYE 상품2'); }
	if (link == 2) {window.open('https://www.lotteon.com/p/product/LE1205916651', '_blank'); CountCheck('EYEYE 상품3'); }
