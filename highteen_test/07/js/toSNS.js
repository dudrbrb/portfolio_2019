...
function toSNS(sns, strTitle, url) {
    ...
    function kakaoShare() {
        ...
        Kakao.Link.sendDefault({
            objectType: 'feed',
            content: {
                title: '반구석의 미스테리한 친구, MYSTERIOUS',
                description: '내가 “하이틴 무비＂에 출연한다면?\n나의 하이틴 재질 알아보기',
                imageUrl: "https://ilotteshopping.com/highteen_test/image/thumb/7.png",
                link: {
                    mobileWebUrl: 'https://ilotteshopping.com/highteen_test/07',
                    webUrl: 'https://ilotteshopping.com/highteen_test/07'
                },
                imageWidth: 1200,
                imageHeight: 600,
            },
